...
function getProducts() {
    return Array.from(document.querySelectorAll("[data-selector=product]")).map((product) => {
        return {
            id: product.getAttribute("data-id"),
            title: product.getAttribute("data-title"),
            brand: product.getAttribute("data-brand"),
            year: parseFloat(product.getAttribute("data-year")),
            practice: product.getAttribute("data-practice"),
            level: product.getAttribute("data-level"),
            weight: parseFloat(product.getAttribute("data-weight")),
            tip: parseFloat(product.getAttribute("data-tip")),
            waist: parseFloat(product.getAttribute("data-waist")),
            tail: parseFloat(product.getAttribute("data-tail")),
            radius: parseFloat(product.getAttribute("data-radius")),
            price: parseFloat(product.getAttribute("data-price")),
            affiliateLink: product.getAttribute("data-affiliate-link"),
            images: JSON.parse(product.getAttribute("data-images")),
        };
    });
}
